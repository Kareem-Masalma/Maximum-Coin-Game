...
"""
    TO DO: 
        Show the moves of the player and the computer
"""
    ...
    def play(self, first=True):
            ...
            if game_type == 'random':
                ...
                with open('data.txt', 'r') as file:
                    ...
                    def calculate(i):
                        ...
                        button_table = Button(game_window, text='Show Table', font=('Arial', 12), fg='#000', bg='#efb539',
        ...
        def start_random(window, entry):
            try:
                ...
                player_list_button = Button(window, text='Show Moves', font=('Arial', 12), fg='#000',
                                            bg='#efb539',
                                            activebackground='#fed570', activeforeground='#000', relief=FLAT, width=10,
                                            height=1)
                player_list_button.place(relx=0.3, rely=0.6, anchor=CENTER)

                # This button will show the moves of the computer
                computer_list_button = Button(window, text='Show Moves', font=('Arial', 12), fg='#000', bg='#efb539',
                                              activebackground='#fed570', activeforeground='#000', relief=FLAT,
                                              width=10,
                                              height=1)
                computer_list_button.place(relx=0.7, rely=0.6, anchor=CENTER)
                ...
                button_table.bind("<Enter>", lambda button: self.button_hover("<Enter>", button_table))
                button_table.bind("<Leave>", lambda button: self.button_leave("<Leave>", button_table))
                player_list_button.bind("<Enter>", lambda button: self.button_hover("<Enter>", player_list_button))
                player_list_button.bind("<Leave>", lambda button: self.button_leave("<Leave>", player_list_button))
                computer_list_button.bind("<Enter>", lambda button: self.button_hover("<Enter>", computer_list_button))
                computer_list_button.bind("<Leave>", lambda button: self.button_leave("<Leave>", computer_list_button))
        ...
        def start_manual(window, entry):
            try:
                ...
                # This button will show the moves of the computer
                computer_list_button = Button(window, text='Show Moves', font=('Arial', 12), fg='#000',
                                              bg='#efb539',
                                              activebackground='#fed570', activeforeground='#000', relief=FLAT,
                                              width=10,
                                              height=1)
                ...
                button_table = Button(window, text='Show Table', font=('Arial', 12), fg='#000', bg='#efb539',
                                      activebackground='#fed570', activeforeground='#000', relief=FLAT, width=10,
                                      height=1, command=lambda: show_table(table))
                button_table.place(relx=0.5, rely=0.5, anchor=CENTER)
                ...
                player_list_button.bind("<Enter>", lambda button: self.button_hover("<Enter>", player_list_button))
                player_list_button.bind("<Leave>", lambda button: self.button_leave("<Leave>", player_list_button))
                computer_list_button.bind("<Enter>",
                                          lambda button: self.button_hover("<Enter>", computer_list_button))
                computer_list_button.bind("<Leave>",
                                          lambda button: self.button_leave("<Leave>", computer_list_button))
        ...
        def show_table(table):
            ...
            for i, row in zip(range(len(table)), table):
                formatted_row = '  '.join(f'{coin:5}' for coin in row)
                text.insert('end', str(i) + formatted_row + '\n')
